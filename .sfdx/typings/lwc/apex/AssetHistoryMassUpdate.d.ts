declare module "@salesforce/apex/AssetHistoryMassUpdate.getCount" {
  export default function getCount(param: {recordId: any}): Promise<any>;
}
declare module "@salesforce/apex/AssetHistoryMassUpdate.getFieldSet" {
  export default function getFieldSet(): Promise<any>;
}
declare module "@salesforce/apex/AssetHistoryMassUpdate.getRecords" {
  export default function getRecords(param: {recordId: any, fieldNameJson: any, pageNumber: any, pageSize: any}): Promise<any>;
}
declare module "@salesforce/apex/AssetHistoryMassUpdate.getDropDown" {
  export default function getDropDown(param: {objName: any, fieldName: any}): Promise<any>;
}
declare module "@salesforce/apex/AssetHistoryMassUpdate.updateRecords" {
...
declare module "@salesforce/apex/AssetHistoryMassUpdate.deleteProject" {
