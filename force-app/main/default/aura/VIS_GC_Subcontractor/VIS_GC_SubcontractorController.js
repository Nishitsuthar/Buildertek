({
    ...
    handleClick : function(component, event, helper) {
        ...
        var elmnt = document.getElementById("pageTop");
            elmnt.scrollIntoView();
                var isValidFields = component.find('GCInput').reduce(function (validSoFar, inputCmp) {
       ...
       var owner1phone = component.find("owner1phone");
        ...
        if(projectphone3value == "" || projectphone3value == undefined){
            ...
            //component.set("v.isValid", isValidFields); 
    ...
    onchangeCompany : function(component, event, helper) {
     ...
     handleFilesChange : function(component, event, helper) {
        ...
        var files='';
         component.set("v.FileLabelList",event.target.files);
         var names =[];
          //alert(JSON.stringify(component.get("v.fileData")));
