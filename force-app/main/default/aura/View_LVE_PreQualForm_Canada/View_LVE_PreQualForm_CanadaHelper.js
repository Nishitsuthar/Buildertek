({
 ...
 submitForm : function(component, event, helper, fileContents,parameters){
    ...
    console.log("JsonString : ",parameters," recordId ",component.get("v.recordId")," projectlist1 : ", JSON.stringify(component.get("v.project1"))," refList1 : ",JSON.stringify(component.get("v.reference1")))
