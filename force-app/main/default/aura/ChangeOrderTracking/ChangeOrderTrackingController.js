                ...
                changeValue : function(component, event, helper) {
                    ...
                    if(updatedLinesInGroup[recIndex]){
                        ...
                        if(localId == "buildertek__Scheduled_Value__c"){
                            updatedLinesInGroup[recIndex].buildertek__Scheduled_Value__c = parseInt(value);
                        } 
                        
                        if(localId == "buildertek__Work_Completed_From_Previous_App__c"){
                            updatedLinesInGroup[recIndex].buildertek__Work_Completed_From_Previous_App__c = parseInt(value);
                        }
                        
                        
                        if(localId == "buildertek__Work_Completed_This_Period__c"){
                            updatedLinesInGroup[recIndex].buildertek__Work_Completed_This_Period__c = Number(value);
                        } 
                        
                        updatedLinesInGroup[recIndex].buildertek__Balance_To_Finish__c = Number(recordItem.buildertek__Scheduled_Value__c) -(Number(recordItem.buildertek__Work_Completed_From_Previous_App__c) +  Number(recordItem.buildertek__Work_Completed_This_Period__c));
                        
                        var TotalAmount = parseInt(recordItem.buildertek__Work_Completed_From_Previous_App__c) + parseFloat(recordItem.buildertek__Work_Completed_This_Period__c);
                       
                        
                        var balToFinish = Number(recordItem.buildertek__Scheduled_Value__c) - (Number(TotalAmount -  Number(recordItem.buildertek__Work_Completed_This_Period__c)));
