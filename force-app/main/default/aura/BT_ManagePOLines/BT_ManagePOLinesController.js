({
        ...
        action.setCallback(this, function(response) {
            if (response.getState() == "SUCCESS") {
                ...
                if (projectData.buildertek__Opportunity__c) {
                    component.set("v.opportunityName", projectData.buildertek__Opportunity__r.Name);
                    component.set("v.opportunityId", projectData.buildertek__Opportunity__r.Id);
                }
    ...
    checkToogle: function(component, event, helper) {
        ...
        helper.formatDataByGroups(component, event, helper, data, component.get("v.fieldmaptype"), component.get("v.sObjectRecords"));
    },
    ...
    handleBTAdmin: function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if (bomRecords != null && bomRecords != undefined && bomRecords.length > 0) {
    ...
    closeProductCodeModal: function(component, event, helper) {
        ...
        if (fieldApiName != null && fieldApiName != undefined && fieldApiName != '' &&
            (fieldApiName == 'buildertek__General_Liability_Insurance_Long__c' || fieldApiName == 'buildertek__Workers_Comp__c' || fieldApiName == 'buildertek__Textura_Fee__c')) {
            var action = component.get("c.handleBTAdmin");
            $A.enqueueAction(action);
        }
    },
    ...
    handleRowAction: function(component, event, helper) {
        ...
        if (actionName == 'state_Country') {
            ...
            component.set('v.fieldAPINameToPass', 'buildertek__Fabrication_Install_Rate__c');
            ...
            component.set('v.fieldAPINameToPass', 'buildertek__Mark_Up_Non_Slab_or_Labor__c');
            component.set('v.fieldLabelToShow', 'Mark Up (Non Slab) or (Non Labor) Rate');
            component.set('v.showProductCodeModal', true);
        } else if (actionName == 'Miscellaneous_Rates') {
            component.set('v.fieldAPINameToPass', 'buildertek__Miscellaneous_Rates__c');
            ...
            component.set('v.fieldAPINameToPass', 'buildertek__General_Liability_Insurance_Long__c');
            ...
            component.set('v.fieldAPINameToPass', 'buildertek__Slab_Discount_Rate_LongText__c');
            component.set('v.fieldLabelToShow', 'Slab Discount Rate');
            component.set('v.showProductCodeModal', true);
        } else if (actionName == 'Fabrication_Labor_Markup') {
            component.set('v.fieldAPINameToPass', 'buildertek__Fabrication_Labor_Mark_up_LongText__c');
            component.set('v.fieldLabelToShow', 'Fabrication / Labor Mark-up');
            component.set('v.showProductCodeModal', true);
        } else if (actionName == 'OCIP_CCIP_Required') {
            component.set('v.fieldAPINameToPass', 'buildertek__OCIP_CCIP_Required__c');
    ...
    submitCountryDetails: function(component, event, helper) {
        ...
        for (var i = 0; i < updatedRecords.length; i++) {
            if (countrySelected != null && countrySelected != undefined) {
                updatedRecords[i].buildertek__Region_State_Country_County__c = countrySelected;
            }
        }
    ...
    validateProposal: function(component, event, helper) {
        ...
        if (totoalBomList != null && totoalBomList != undefined && totoalBomList.length > 0) {
