    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < entries.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style="width:16px;height:16px;background-color:' + entry.color + ';overflow:hidden; -webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px;"></div></td>' +
                    '<td class="legendLabel">' + entry.label + '</td>'
                );
            }
