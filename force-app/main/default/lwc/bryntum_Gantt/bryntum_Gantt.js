...
export default class Gantt_component extends NavigationMixin(LightningElement){
    ...
    handleaccountSelectionContractor(event){
        ...
        console.log('this.selectedResourceAccount in handle sele>>>',this.selectedResourceAccount);
    }
    saveSelectedContact(){
        var that = this;
        if(!this.taskRecordId.includes('_generated')){
            ...
            if(this.contracFieldApiName == 'buildertek__Contractor__c'){
                ...
                saveResourceForRecord({taskId: this.taskRecordId,resourceId: this.selectedResourceAccount,resourceApiName: this.contracFieldApiName}).then(function(response){
    ...
    populateIcons(record){
        if(record.row){
            if(record.row._allCells.length){
                if(record.record._data.type == 'Project' && record.row._allCells[5].innerHTML){
                    //var iconElement = '<i class="b-fa b-fa-calendar"></i>'
                    ...
                    if(record.row._allCells[5].children[0]){
                        if(record.row._allCells[5].children[0].innerHTML.indexOf('custom70') == -1){
                            record.row._allCells[5].children[0].innerHTML = iconElement + record.row._allCells[5].children[0].innerHTML
                        }
                    }
                }
                if(record.record._data.type == 'Phase' && record.row._allCells[5].innerHTML){
                    ...
                    if(record.row._allCells[5].children[0]){
                        if(record.row._allCells[5].children[0].innerHTML.indexOf('slds-icon-standard-task') == -1){
                            record.row._allCells[5].children[0].innerHTML = iconElement + record.row._allCells[5].children[0].innerHTML
                        }
                    }   
                }
                if(record.record._data.type == 'Task' && record.row._allCells[5].innerHTML){
                    if(record.record._data.iconCls == 'b-fa b-fa-arrow-left indentTrue' && record.row._allCells[5].children[0].classList.contains('indentCellTrue') == false){
                        if(record.row._allCells[5].children[0]){
                            record.row._allCells[5].children[0].classList.add('indentCellTrue');
                        }
                        if(record.record._data.name == 'Milestone Complete' || record.record._data.customtype == 'Milestone'){
                            ...
                            if(record.row._allCells[5].children[0]){
                                if(record.row._allCells[5].children[0].innerHTML.indexOf('slds-icon-utility-multi_select_checkbox') == -1){
                                    record.row._allCells[5].children[0].innerHTML = iconElement + record.row._allCells[5].children[0].innerHTML
                                }
                            }
                        }else{
                    ...
                    }else if(record.record._data.iconCls != 'b-fa b-fa-arrow-left indentTrue'){
                        if(record.record._data.name == 'Milestone Complete' || record.record._data.customtype == 'Milestone'){
                            var iconElement = `<span class="slds-icon_container slds-icon-custom-custom8" style="background:white;">
                                                    <svg aria-hidden="true" class="slds-icon slds-icon-text-default" style="fill: #e56798 !important;height:1.2rem;width:1.2rem;">
                                                        <use xmlns:xlink=" http://www.w3.org/1999/xlink" xlink:href="/apexpages/slds/latest/assets/icons/custom-sprite/svg/symbols.svg#custom8">
                            ...
                            if(record.row._allCells[5].children[0]){
                                if(record.row._allCells[5].children[0].innerHTML.indexOf('slds-icon-custom-custom8') == -1){
                                    record.row._allCells[5].children[0].innerHTML = iconElement + record.row._allCells[5].children[0].innerHTML
                                }
                            }
                        }else{
                            ...
                            if(record.row._allCells[5].children[0]){
                                if(record.row._allCells[5].children[0].innerHTML.indexOf("slds-icon-standard-task2") == -1){
                                    record.row._allCells[5].children[0].innerHTML = iconElement + record.row._allCells[5].children[0].innerHTML
                                }
                            } 
                        } 
    ...
    populateIconsOnExpandCollapse(source){
        var rowPhaseElement = this.template.querySelector('[data-id="'+source.record.id+'"]')
        if(rowPhaseElement && rowPhaseElement.innerHTML){
            ...
            if(source.record.type == 'Phase'){
                ...
                if(rowPhaseElement.innerHTML.indexOf('slds-icon-standard-task') == -1){
                    if(rowPhaseElement.children.length){
                        if(rowPhaseElement.children[5].children.length){
                            rowPhaseElement.children[5].children[0].innerHTML = iconElement+rowPhaseElement.children[5].children[0].innerHTML
                        }
                    } 
                }
                ...
                if(rowPhaseElement.innerHTML.indexOf('slds-icon-custom-custom70') == -1){
                    if(rowPhaseElement.children.length){
                        if(rowPhaseElement.children[5].children.length){
                            rowPhaseElement.children[5].children[0].innerHTML = iconElement+rowPhaseElement.children[5].children[0].innerHTML
                        }
    ...
    createGantt() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    actions : [{
                        ...
                        onClick : ({ record}) => {
                            // console.log({record});
                            if(record._data.type == 'Task' && record._data.id.indexOf('_generate') == -1){
                                this.taskRecordId = record._data.id;
                                this.getRecordData(record._data.id,record._data);
                            }
                        },
                        renderer : ({ action, record }) => {
                            if(record._data.type == 'Task' && record._data.id.indexOf('_generate') == -1){//&& record._data.id.indexOf('_generate') == -1
                ...
                },
                {
                    ...
                    renderer: (record) =>{
                        this.populateIcons(record);
                        if(record.record._data.name == 'Milestone Complete'){
                            var phasePercent = record.record.taskStore.storage.getBy('_internalId',record.record._parent._internalId).percentDone
                            //console.log('percentDone-->',phasePercent)
                            if(phasePercent != record.record.percentDone){
                                //record.record._data.percentDone = phasePercent
                                //record.record.set('percentDone',phasePercent);
                            }
                        }
                 ...
                 { 
                    ...
                    filterable : ({ record, value, operator }) => {
                        if(record._data.internalresourcename && value){
                            if(record._data.internalresourcename.toUpperCase().indexOf(value.toUpperCase()) > -1){
                                return true;
                            }
                        }
                    }
                ...
                { 
                    ...
                    renderer : function (record) {                        
                        if(record.record._data.type == 'Task' && record.record._data.name != 'Milestone Complete'){
                            if(record.record._data.contractoracc){
                                ...
                                //${record.record._data.contractor} on line no.1628
                            }else{
                                record.cellElement.innerHTML = `
                    ...
                    filterable : ({ record, value, operator }) => {
                       if(record._data.contractorresourcename && value){
                            if(record._data.contractorresourcename.toUpperCase().indexOf(value.toUpperCase()) > -1){
                                return true;
                            }
                        }
                    }
                ...
                beforerendertask : ({source}) =>{
                    if(source.selectedRecordCollection){
                        if(source.selectedRecordCollection._values.length){
                            if(source.selectedRecordCollection._values[0].predecessors.length == 0 && (source.selectedRecordCollection._values[0].constraintType == '' || source.selectedRecordCollection._values[0].constraintType == null)){
                                source.selectedRecordCollection._values[0].set('constraintType','startnoearlierthan')
                                source.selectedRecordCollection._values[0].set('predecessor',undefined);
                                source.selectedRecordCollection._values[0].set('constraintDate', source.selectedRecordCollection._values[0].data.startDate);
                                ////console.log('constriant-->',source.selectedRecordCollection._values[0].constraintType)
                                ////console.log('constriant-->',source.selectedRecordCollection._values[0].constraintDate)
                            }else if(source.selectedRecordCollection._values[0].predecessors.length == 0){
                                source.selectedRecordCollection._values[0].set('constraintDate', source.selectedRecordCollection._values[0].data.startDate);
                                source.selectedRecordCollection._values[0].set('predecessor',undefined);
                            }
                            ////console.log('constriant-->3',source.selectedRecordCollection._values[0].constraintDate)
                        }
                    }
                    if(this.GanttVar){
                ...
                if(taskRecord._data.type == 'Phase'){
                    if(taskRecord._data.children){
                        if(taskRecord._data.children.length){
                            ...
                            if(phaseTask.children[phaseTask.children.length-1].name == 'Milestone Complete'){
                                if(phaseTask.children[phaseTask.children.length-1].percentDone != taskRecord.percentDone){
                                    phaseTask.children[phaseTask.children.length-1].percentDone = taskRecord.percentDone
                                }
                                //phaseTask.children[phaseTask.children.length-1].percentDone = taskRecord.percentDone;
                                //phaseTask._data.children[phaseTask._data.children.length-1].percentDone = taskRecord._data.percentDone
                            }
                        }
                    }
       ...
       // gantt.generateDataset();
        ...
        var lastInteractedTask = window.sessionStorage.getItem('lastInteractedTaskId');
        if(lastInteractedTask){
            var taskRec = this.GanttVar.taskStore.getById(lastInteractedTask);
            if(taskRec){
                this.GanttVar.scrollTaskIntoView(taskRec, { block : 'start', animate : 500, edgeOffset :50,highlight:true, focus: false});
            }
        ...
        gantt.addListener('cellClick', (event) =>  {
            ...
            if(event.target.classList.contains('b-fa-arrow-right')){
                ...
                event.target.parentElement.parentElement.classList.add('indentCellTrue')
                ...
                event.target.parentElement.parentElement.classList.remove('indentCellTrue');
                ...
                window.sessionStorage.setItem('lastInteractedTaskId',event.record._data.id);
            }
            ...
            if(event.column.data.text == 'Contractor Resource'){
                if(event.target.id == 'editcontractorResource'){
                    ...
                    if(event.target.dataset.resource){
                        ...
                        console.log('this.selectedResourceContact>>>',this.selectedResourceContact);
                    }
        ...
        gantt.on('expandnode', (source) => {
            ////console.log(this.template.querySelector('[data-id="'+source.record.id+'"]'));
