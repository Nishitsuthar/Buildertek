        ...
        if (Trigger.isInsert){
            ...
            if (Trigger.isBefore){
                ...
                if (ProjectTaskTriggerHandler.blnSkipTaskTrigger){
                    ...
                    ProjectTaskTriggerHandler.OnAfterInsertItemCount(JSON.serialize(Trigger.new ), JSON.serialize(Trigger.old), Trigger.isInsert, Trigger.isUndelete, Trigger.isDelete);
